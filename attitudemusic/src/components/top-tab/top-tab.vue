<template>
  ...
  <div class="music-btn">
    ...
    <router-link to="/music/artist" tag="span">歌手</router-link>  
    ...
    <router-link class="none-414" to="/music/userSong" tag="span">我喜欢</router-link>
    <router-link class="none-414" to="/music/video" tag="span">我的mv</router-link>
